...
-- Interior grid: 10×10 exact LUT samples, sqrt-warped axes
def pbIntNR : Nat := 10
def pbIntNC : Nat := 10
def pbTopRows : Nat := 8
...
def pbIntGrid : Array Float := #[
  ...
  0.678711, 0.639160, 0.585449, 0.512207, 0.439697, 0.369873, 0.302734, 0.235107, 0.172852, 0.109192,
  0.726562, 0.681152, 0.620117, 0.535645, 0.452637, 0.372803, 0.296631, 0.221313, 0.153320, 0.086304,
  0.813477, 0.757324, 0.681152, 0.575684, 0.472656, 0.374756, 0.283691, 0.196655, 0.122375, 0.054810,
  0.994629, 0.911621, 0.800293, 0.647461, 0.501465, 0.368164, 0.251465, 0.149658, 0.074341, 0.019226,
  1.485352, 1.308594, 1.078125, 0.778320, 0.516113, 0.307129, 0.157471, 0.060822, 0.015564, 0.000557,
...
-- r_nodes in sqrt(roughness) space: uniform over [0, pbRsqMax]
def pbRNodes : Array Float :=
  #[0.000000, 0.107555, 0.215109, 0.322664, 0.430219, 0.537773, 0.645328, 0.752882, 0.860437, 0.967992]
